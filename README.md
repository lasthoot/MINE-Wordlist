...
3. Save the ZIP file in a folder you recognize (like Downloads).

---

## 🛠️ Installing and Using the Wordlists on Windows
...
4. Pick a destination folder, such as Desktop or Documents.
5. Click "Extract".

Now, you have access to the wordlist files.

### Step 2: Open wordlists
...
### Step 3: Apply the wordlists in your tools
...
## 📖 How to Use Wordlists for Fuzzing (Basic Idea)

1. Choose the target system or application to test.
2. Use a fuzzing tool or script.
3. Load one or more wordlist files as input for the tool.
4. Run the test. The tool will try values from the lists.
5. Review the results from your tool for issues or errors.
...
- `mine-private.txt` – Core wordlist focused on Mine Private terms.
- `common-words.txt` – Frequently used words for general fuzzing.
- `extensions.txt` – Common file extensions useful for testing file inputs.
- `paths.txt` – Typical path and directory names to try.
